...
public class ItemBlockKiln extends CosmosItemBlock {

	public ItemBlockKiln(Block block, Item.Properties properties, String description, String shift_desc_one, String shift_desc_two) {
