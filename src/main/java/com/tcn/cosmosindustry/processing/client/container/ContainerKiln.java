...
public class ContainerKiln extends CosmosContainerMenuBlockEntity {
	...
	public ContainerKiln(int indexIn, Inventory playerInventoryIn, Container contentsIn, ContainerLevelAccess accessIn, BlockPos posIn) {
		super(IndustryModBusManager.CONTAINER_TYPE_KILN, indexIn, playerInventoryIn, accessIn, posIn);
		...
		/**@OutputSlot*/
		this.addSlot(new FurnaceResultSlot(player, contentsIn, 2, 104, 58));
	...
	public boolean stillValid(Player playerIn) {
		return stillValid(this.access, playerIn, IndustryModBusManager.BLOCK_KILN);
	}
