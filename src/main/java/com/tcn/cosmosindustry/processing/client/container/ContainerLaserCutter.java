...
public class ContainerLaserCutter extends CosmosContainerMenuBlockEntity {
	...
	public ContainerLaserCutter(int indexIn, Inventory playerInventoryIn, FriendlyByteBuf extraData) {
	...
	public ContainerLaserCutter(int indexIn, Inventory playerInventoryIn, Container contentsIn, ContainerLevelAccess accessIn, BlockPos posIn) {
		super(IndustryModBusManager.CONTAINER_TYPE_LASER_CUTTER, indexIn, playerInventoryIn, accessIn, posIn);
		...
		/**@OutputSlot*/
		this.addSlot(new SlotLaserCutter(player, contentsIn, 2, 104, 58));
	...
	public boolean stillValid(Player playerIn) {
		return stillValid(this.access, playerIn, IndustryModBusManager.BLOCK_LASER_CUTTER);
	}
