...
public class SlotCompactor extends Slot {
	...
	public SlotCompactor(Player entity_player, Container inventory, int index, int x_pos, int y_pos) {
	...
	protected void checkTakeAchievements(ItemStack stack) {
		...
		if (!this.player.level.isClientSide) {
			int i = this.amount;
			float f = CompactorRecipes.getInstance().getRecipeExperienceValue(stack);
