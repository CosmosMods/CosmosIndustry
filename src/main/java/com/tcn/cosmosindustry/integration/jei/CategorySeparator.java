...
public class CategorySeparator implements IRecipeCategory<SeparatorRecipe> {
	...
	public CategorySeparator(IGuiHelper helperIn) {
		...
		this.background = this.helper.createDrawable(PROCESSING.SEPARATOR_LOC_GUI_JEI, 0, 0, 112, 66);
	...
	public Component getTitle() {
		return ComponentHelper.locComp(ComponentColour.WHITE, false, "cosmosindustry.integration.jei.separator_category");
	}
	...
	public IDrawable getIcon() {
		return this.helper.createDrawableIngredient(VanillaTypes.ITEM, new ItemStack(IndustryModBusManager.BLOCK_SEPARATOR));
	}
	
	@Override
	public void draw(SeparatorRecipe recipe, PoseStack stack, double mouseX, double mouseY) {
