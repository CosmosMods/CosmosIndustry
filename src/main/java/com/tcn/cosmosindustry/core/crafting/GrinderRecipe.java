...
public class GrinderRecipe implements Recipe<Container> {
	...
	public GrinderRecipe(ResourceLocation idIn, Ingredient inputIn, ItemStack resultIn, ItemStack secondaryOutputIn) {
		this.id = idIn;
		this.input = inputIn;
	...
	public ItemStack getToastSymbol() {
		return new ItemStack(IndustryModBusManager.BLOCK_GRINDER);
	}
	...
	public RecipeSerializer<?> getSerializer() {
		return IndustryCraftingManager.RECIPE_SERIALIZER_GRINDING;
	}

	@Override
	public RecipeType<?> getType() {
		return IndustryCraftingManager.RECIPE_TYPE_GRINDING;
	}
	...
	public static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<GrinderRecipe> {
		
		@Override
		public GrinderRecipe fromJson(ResourceLocation idIn, JsonObject recipeIn) {
			...
			return new GrinderRecipe(idIn, input, result, secondaryResult);
		}

		@Override
		public GrinderRecipe fromNetwork(ResourceLocation idIn, FriendlyByteBuf extraDataIn) {
		...
		@Override
		public void toNetwork(FriendlyByteBuf extraDataIn, GrinderRecipe recipeIn) {
